...
namespace NppPlugin.DllExport.MSBuild
{
	...
	public class DllExportAppDomainIsolatedTask : AppDomainIsolatedTask, IDllExportTask, IInputValues, IServiceProvider
	{
		...
		{
			_ExportTaskImplementation = new ExportTaskImplementation<DllExportAppDomainIsolatedTask>(this);
		}
		...
		{
			return ((IServiceProvider)_ExportTaskImplementation).GetService(serviceType);
		}
